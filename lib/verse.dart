...
class _VerseState extends State<Verse> {
  List<Map<String, String>> verse = [
    ...
    },
    {
      ...
      "L2":
          "قال رسول الله -صلى الله عليه وسلم-: (مَثَلُ الذي يَقْرَأُ القُرْآنَ كالأُتْرُجَّةِ: طَعْمُها طَيِّبٌ، ورِيحُها طَيِّبٌ، والذي لا يَقْرَأُ القُرْآنَ كالتَّمْرَةِ: طَعْمُها طَيِّبٌ، ولا رِيحَ لَها، ومَثَلُ الفاجِرِ الذي يَقْرَأُ القُرْآنَ كَمَثَلِ الرَّيْحانَةِ: رِيحُها طَيِّبٌ، وطَعْمُها مُرٌّ، ومَثَلُ الفاجِرِ الذي لا يَقْرَأُ القُرْآنَ كَمَثَلِ الحَنْظَلَةِ: طَعْمُها مُرٌّ، ولا رِيحَ لَها).",
    },
    {
      "L1": "صحيح البخاري عن القرآن",
      "L2":
          "ال رسول الله صلى الله عليه وسلم: (خَيْرُكُمْ مَن تَعَلَّمَ القُرْآنَ وعَلَّمَهُ. قالَ: وأَقْرَأَ أبو عبدِ الرَّحْمَنِ في إمْرَةِ عُثْمانَ، حتَّى كانَ الحَجَّاجُ قالَ: وذاكَ الذي أقْعَدَنِي مَقْعَدِي هذا).",
    },
    {
      "L1": "صحيح البخاري عن القرآن",
      "L2":
    ...
    },
    {
      "L1": "صحيح البخاري عن بر الوالدين",
      "L2":
          "روي عن عبدالله بن عمرو أنه جَاءَ رَجُلٌ إلى النبيِّ -صَلَّى اللهُ عليه وسلَّمَ-، فَاسْتَأْذَنَهُ في الجِهَادِ، فَقَالَ: (أحَيٌّ والِدَاكَ؟، قَالَ: نَعَمْ، قَالَ: فَفِيهِما فَجَاهِدْ).",
    },
    {
      "L1": "صحيح البخاري عن بر الوالدين",
      "L2":
                ...
                Row(
                  ...
                  children: [
                    FloatingActionButton(
                      ...
                      onPressed: () {
                        setState(() {
                          counter == verse.length - 1 ? counter = 0 : counter++;
                        });
                      },
                      backgroundColor: Colors.orange,
                      child: const Icon(Icons.arrow_back_ios_new_sharp,
                          color: Colors.white, size: 25, weight: 50.0),
                    ),
                    const SizedBox(
                      width: 30.0,
                    ),
                    FloatingActionButton(
                      ...
                      onPressed: () {
                        setState(() {
                          counter == 0 ? counter = verse.length - 1 : counter--;
                        });
                      },
                      backgroundColor: Colors.orange,
